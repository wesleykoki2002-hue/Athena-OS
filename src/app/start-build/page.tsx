      ...
      gatePreview = await previewCanonicalPreBuildGate({
        ...
        requestEvidence: {
          ...
          target_supabase_project_verified:
            localEvidence.targetSupabaseProjectVerified,
          target_supabase_project_ref: localEvidence.targetSupabaseProjectRef,
          target_supabase_applicability:
            localEvidence.targetSupabaseApplicability,
          ...
          preview_only: true,
          evidence_schema: "canonical-pre-build-gate-preview-v3"
        }
      });
    } catch (error) {
      gatePreviewError =
